...
set project_dir [file join $repo_dir build vivado_pynq_z2_sync_mmcm]
set output_dir [file join $repo_dir build bitstream_pynq_z2_sync_mmcm]
set project_file [file join $project_dir rv32_dsp_pynq_z2_sync_mmcm.xpr]
...
write_bitstream -force [file join $output_dir rv32_pynq_z2_sync_mmcm_demo.bit]
puts "MMCM PYNQ-Z2 bitstream generated at $output_dir"
close_project
