...
set mem_file [file join $repo_dir mem pynq_demo.mem]
set xdc_file [file join $repo_dir vivado constraints pynq_z2_demo.xdc]

create_project -force rv32_dsp_pynq_z2 $project_dir -part xc7z020clg400-1
...
puts "Created PYNQ-Z2 demo project at $project_dir"
close_project
