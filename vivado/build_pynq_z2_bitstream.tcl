...
set output_dir [file join $repo_dir build bitstream_pynq_z2]
set mem_file [file normalize [file join $repo_dir mem pynq_demo.mem]]
set project_file [file join $project_dir rv32_dsp_pynq_z2.xpr]
...
if {[get_property STATUS [get_runs impl_1]] != "write_bitstream Complete!"} {
    error "Implementation or bitstream generation did not complete successfully"
}
...
write_bitstream -force [file join $output_dir rv32_pynq_z2_demo.bit]
puts "PYNQ-Z2 bitstream generated at $output_dir"
close_project
