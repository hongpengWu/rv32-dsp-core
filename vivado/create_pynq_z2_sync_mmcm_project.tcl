...
set xdc_file [file join $repo_dir vivado constraints pynq_z2_sync_mmcm_demo.xdc]

create_project -force rv32_dsp_pynq_z2_sync_mmcm $project_dir -part xc7z020clg400-1
...
puts "Created MMCM PYNQ-Z2 project at $project_dir"
close_project
